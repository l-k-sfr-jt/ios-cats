...
extension Font {
    static let appSectionTitle = clashDisplayVariableBoldSemibold(ofSize: 24, relativeTo: .title)
    
    static let appItemLargeTitle = clashDisplayVariableBoldSemibold(ofSize: 24, relativeTo: .title)
